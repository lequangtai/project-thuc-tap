...
<input type="hidden" name="_token" value="{{ csrf_token() }}">
	<fieldset>
		...
		<span class="form_item">
			<textarea name="txtFull" rows="8" class="textbox">{!!old('txtFull', isset($data_news["content"]) ?$data_news["content"] :null)!!}</textarea>
			<script type="text/javascript">
		...
		<span class="form_item">
			...
			<img src="{!! isset($data_news["image"]) ? asset('public/uploads/news/'.$data_news["image"]) :asset('public/tt13_admin/templates/images/nophoto.png') !!}" width="100px" />
