      ...
      <div class="TTTT">
          ...
          <!-- <div class="box-right"> -->
             <div class="panel panel-primary" id="tin">
              ...
              <div class="panel-body">
                  <p><strong style="color: red; text-align: center;">{!! $item['title']!!}</strong></p>
                  <div style="text-align: left;">
                  <p><strong>{!! $item['intro']!!}</a></strong></p>
                    <p>{!! $item['content']!!}</p>
                    </div>
                  <a href="{!! route('getTVSDD') !!}"><span class="glyphicon glyphicon-backward" aria-hidden="true"> Trở lại</span></a>
              </div>
     </div>
    </div>
    @endforeach
