@extends('user.master')
@section('title','Chi tiết tin mới')
@section('content')
<div id="content-left">
      ...
      <div class="TTTT">
          ...
          <!-- <div class="box-right"> -->
            <div class="panel panel-primary" id="tin">
              ...
              <div class="panel-body">
                   <div class="box-tin" style="height: 220px">
                    <div class="tin-img"><img src="{!! asset('public/uploads/News/'.$news["image"]) !!}" width="140px" height="140px" /></div>
                  <div class="tomtattin" style="text-align: left;">
                    <p class="tin1">{!! $news['title']!!}</p>
                    <p class="tin2">{!! $news['intro']!!}</p>
                  </div>
                  </div>  
              <div>
                  <p>
